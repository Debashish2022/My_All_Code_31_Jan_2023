...
function Dashboard(props) {
        ...
        {[
          ...
          <ListItem key={text} disablePadding>
            <ListItemButton>
              <ListItemIcon>
                {index === 0 ? (
                  <DashboardIcon onClick={() => setToggle("Dashboard")} />
                ) 
                // : index === 1 ? (
                ...
                // )
                //  : index === 3 ? (
                //   <EventNoteOutlinedIcon onClick={() => setToggle("Payin")} />
                // ) 
                : index === 1 ? (
                  <GradingRoundedIcon onClick={() => setToggle("Payout")} />
                ) : index === 2 ? (
                  <AccountCircleOutlinedIcon
              ...
              <ListItemText primary={text} onClick={() => setToggle(text)} />
            </ListItemButton>
          </ListItem>
        ))}
      </List>
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      {/* {toggle === "Reseller Profile" ? <UserProfileAccount /> : null} */}
